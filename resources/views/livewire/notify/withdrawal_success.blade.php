			...
			<div class="row">
				<div class="col-md-8 col-lg-6 col-xl-5 mx-auto">
					...
					<div class="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
						...
						<p class="text-center text-3 mb-4">You've successfully Withdrawed
							<span class="text-4 font-weight-500">
								{{ $setting->currency }}{{ number_format($transaction->amount, 2) }}
							</span>
							Money, See transaction details under <a href="{{ route('transactions') }}">Activity</a>.
						</p>
						<a href="{{ route('withdrawal') }}" class="btn btn-primary btn-block">Withdraw Money Again</a>

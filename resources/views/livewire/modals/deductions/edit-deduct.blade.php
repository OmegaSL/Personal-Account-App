...
<div wire:ignore.self id="editDeductionModal" class="modal fade" role="dialog" aria-hidden="true" data-backdrop="static"
	data-keyboard="false">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title font-weight-400">Edit deduction</h5>
			...
			<div class="modal-body p-4">
				<form wire:submit.prevent='updateDeduction'>
					...
					{{-- <div class="form-group">
						...
						<input type="date" class="form-control" min="0" wire:model.defer="deduction_start_date"

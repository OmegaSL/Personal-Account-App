...
class DeductionPolicy
{
    ...
    {
        return $user->can('force_delete_deduction');
    }
    ...
    {
        return $user->can('force_delete_any_deduction');
    }
    ...
    {
        return $user->can('restore_deduction');
    }
    ...
    {
        return $user->can('restore_any_deduction');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Deduction $deduction)
    {
